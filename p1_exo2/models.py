...
class Constants(BaseConstants):
    ...
    max_report = 30
    num_blocks = 144
    instructions_template= 'p1_exo2/Instructions.html'
    instructions_beliefs = 'p1_exo2/InstructionsBeliefs.html'
    instructions_belief_number = 'p1_exo2/Instbeliefnumber.html'
    instructions_belief_yesno = 'p1_exo2/Instbeliefyesno.html'
