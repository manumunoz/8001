...
class Constants(BaseConstants):
    ...
    max_report = 30
    num_blocks = 144
    instructions_template= 'p3_exo3/Instructions.html'
    instructions_beliefs = 'p3_exo3/InstructionsBeliefs.html'
    instructions_belief_number = 'p3_exo3/Instbeliefnumber.html'
    instructions_belief_hiddennumber = 'p3_exo3/Instbeliefhiddennumber.html'
    instructions_belief_yesno = 'p3_exo3/Instbeliefyesno.html'
    exo_prob_show = 80 # Complete for EXO once ENDO is conducted
    exo_prob_no_show = 20 # Complete for EXO once ENDO is conducted

    with open('p3_exo3/imp_p2_exo3.csv', 'r') as f:
        reader = csv.reader(f)
