...
doc = """
Web of Lies P1_ENDO2
"""


class Constants(BaseConstants):
    name_in_url = 'MTurk_P1_endo2'
    ...
    max_report = 30
    num_blocks = 144
    instructions_template= 'p1_endo2/Instructions.html'
    instructions_beliefs = 'p1_endo2/InstructionsBeliefs.html'
    instructions_belief_number = 'p1_endo2/Instbeliefnumber.html'
    instructions_belief_yesno = 'p1_endo2/Instbeliefyesno.html'
...
class Player(BasePlayer):
    # Treat. 6: FRST2, 7: NO2, 8:EXO2, 9:ENDO2, 10:VCTM2
