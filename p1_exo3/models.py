...
class Constants(BaseConstants):
    ...
    max_report = 30
    num_blocks = 144
    instructions_template= 'p1_exo3/Instructions.html'
    instructions_beliefs = 'p1_exo3/InstructionsBeliefs.html'
    instructions_belief_number = 'p1_exo3/Instbeliefnumber.html'
