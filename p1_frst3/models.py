...
class Constants(BaseConstants):
    ...
    max_report = 30
    num_blocks = 144
    instructions_template= 'p1_frst3/Instructions.html'
    instructions_beliefs = 'p1_frst3/InstructionsBeliefs.html'
    instructions_belief_number = 'p1_frst3/Instbeliefnumber.html'
    instructions_belief_yesno = 'p1_frst3/Instbeliefyesno.html'
