...
class Constants(BaseConstants):
    ...
    max_report = 30
    num_blocks = 144
    instructions_template= 'p1_no2/Instructions.html'
    instructions_beliefs = 'p1_no2/InstructionsBeliefs.html'
    instructions_belief_number = 'p1_no2/Instbeliefnumber.html'
    instructions_belief_yesno = 'p1_no2/Instbeliefyesno.html'
