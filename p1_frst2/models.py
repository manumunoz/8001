...
doc = """
Web of Lies P1_FRST2
"""


class Constants(BaseConstants):
    name_in_url = 'MTurk_P1_frst2'
    ...
    max_report = 30
    num_blocks = 144
    instructions_template= 'p1_frst2/Instructions.html'
    instructions_beliefs = 'p1_frst2/InstructionsBeliefs.html'
    instructions_belief_number = 'p1_frst2/Instbeliefnumber.html'
    instructions_belief_yesno = 'p1_frst2/Instbeliefyesno.html'
